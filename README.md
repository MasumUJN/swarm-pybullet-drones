...
New environments can be found in the [env](https://github.com/trangml/swarm-pybullet-drones/gym_pybullet_drones/envs) directory.
These use configurations of the reward and terminations that can be found in [rewards](https://github.com/trangml/swarm-pybullet-drones/gym_pybullet_drones/envs/single_agent_rl/rewards).
